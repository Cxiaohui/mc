...
use app\common\model\Feedback as mDK;
...
class Feedback extends Common{
    ...
    public function index(){
        ...
        $this->assign('flink',$this->filterLink($sop['p']['f'],$types));
    ...
    public function do_it(){
        ...
        if($res){
            \app\gerent\model\Adminoperlog::instance()->save_data('处理反馈：'.$id);
            $this->success('处理成功',url('Feedback/info',['id'=>$id]));
        }
        $this->error('处理失败');
