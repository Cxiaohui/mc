...
class Show extends Common{
    ...
    public function modify_post(){
        ...
        Plog::add_one($post['p_id'],$info['id'],$log_type[$info['type']],['type'=>2,'id'=>$this->user_id,'name'=>'业主'],'[修改]'.$post['content']);
    ...
    public function pass_post(){
        ...
        Plog::add_one($p_id,$info['id'],$log_type[$info['type']],['type'=>2,'id'=>$this->user_id,'name'=>'业主'],'[通过]');
